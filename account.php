...
include_once 'dbConnection.php';
echo '<span class="pull-right top title1" style="color:white" ><span class="log1" style="color:white"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;Welcome,</span> <a href="account.php?q=1" class="log log1" style="color:white">'.$name.'</a>&nbsp;|&nbsp;<a href="logout.php?q=account.php" class="log" style="color:white"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Signout</a></span>';
}?>
</div>
</div></div>
<div class="bg">
  ...
  <div class="container-fluid navbar-dark">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
		...
		<li <?php if(@$_GET['q']==3) echo'class="active"'; ?>><a href="account.php?q=3"style="color:white"><span class="glyphicon glyphicon-stats" aria-hidden="true"></span>&nbsp;Ranking</a></li></ul>
