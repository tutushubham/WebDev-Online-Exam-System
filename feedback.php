    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="Navbar">
            ...
            <?php
              ...
              echo '<a href="#" class="btn btn-dark" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-log-in" aria-hidden="true"></span>&nbsp;Login</a>&nbsp;';}
              else
              {
              echo '<a href="logout.php?q=feedback.php" class="pull-right btn btn-dark"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Signout</a>&nbsp;';}
            ?>
            <a href="#" class="btn btn-dark" data-toggle="modal" data-target="#login"><span class="glyphicon glyphicon-log-in" aria-hidden="true"></span>&nbsp;Admin Login</a>
        </div>        
    </div>
</nav>  
...
<div class="col-md-6 panel" style="background-color:floralwhite; min-height:430px;margin-top: 5vw;">
<h2 align="center" style="font-family:'typo'; color:#000066">GIVE YOUR FEEDBACK</h2>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" style = "color: white" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
